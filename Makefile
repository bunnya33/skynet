...
$(LUA_CLIB_PATH)/client.so : lualib-src/lua-clientsocket.c lualib-src/lua-crypt.c lualib-src/lsha1.c lualib-src/lmd5.c lualib-src/lsha2.c lualib-src/lcrc.c | $(LUA_CLIB_PATH)
